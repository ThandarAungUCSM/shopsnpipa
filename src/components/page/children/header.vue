...
<!--			<div class="input-main fl" v-if="sea"><input type="text" placeholder="请输入商品名称..." v-model="$store.state.search_value" @keyup.enter="submit(value)"></div>-->
			<div class="input-main fl" v-if="sea">
				<input type="text" class="head-text" placeholder="搜索商品..." v-model="$store.state.search_value" @keyup.enter="submit(value)">
...
<!--				<span class="fl"></span>-->
<!--			</div>-->
			<div class="btn-ng clearfix" @click="toLink('/myNews')">
				<img src="../../../assets/message-list.png" class="head-mess">
			</div>
