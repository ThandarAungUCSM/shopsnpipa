      ...
      this.axios
        ...
        .then(res => {
          ...
          if (res.data.status == 1) {
            ...
            if (this.$store.state.scanGoodsType == 1) {
              this.$router.push({
                name: "product",
                params: {
                  id: this.$store.state.scanID,
                  status: 1
                }
              });
            } else if (this.$store.state.goodsType == 2) {
              this.$router.push({
                name: "auctionList",
                params: {
                  goods_id: this.$store.state.hotGoodsID
                }
              });
            } else if (this.$store.state.integralType == 3) {
              this.$router.push({
                name: "integralDetail",
                params: {
                  id: this.$store.state.integralID,
                  status: 2
                }
              });
            } else {
...
.logoin-main {
  ...
  .from {
    ...
    .userName {
      .icon {
        background: url(../../assets/images/footer_person.png) no-repeat center;
