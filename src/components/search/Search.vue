...
export default {
  ...
  created() {
    if (
      sessionStorage.getItem("hit") != "" &&
      sessionStorage.getItem("hit") != "undefined" &&
      sessionStorage.getItem("hit") != null
    ) {
    ...
    .hot {
      .title {
        ...
        span {
          ...
          top: 50%;
          margin-top: -0.155rem;
          background: url(../../assets/images/tj.png) no-repeat;
