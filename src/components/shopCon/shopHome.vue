  ...
  <div class="box" v-loading="loading">
    ...
    <div class="content">
      ...
      <div v-if="titleData == 0">
        ...
        <!--Coupon-->
        <coupons :id="this.$route.params.id"></coupons>
        ...
        <!-- 店铺首页的热门商品 -->
        <article-list :temList="0" :id="this.$route.params.id"></article-list>
...
import qs from "qs";
import toTop from "@/components/page/toTop";
    ...
    methods: {
        ...
        getReGoods() {
            ...
            else
            {
                ...
                var params = { store_id: this.$route.params.id, page: this.page };
