...
export default {
  ...
  created() {
    this.$store.state.goodsType = this.$route.query.type;
    this.$store.state.hotGoodsID = this.$route.params.goods_id;
    console.log(this.$store.state.hotGoodsID, 333);
    console.log(this.$store.state.goodsType, 111);
    this.getDetail();
  },
  mounted() {
    var now = new Date();
...
.navs {
  ...
  .navs {
    ...
    ul {
      ...
      .active {
        border-bottom: 0.03rem solid #d02629;
      }
    }
  }
