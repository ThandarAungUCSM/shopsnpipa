...
const AddtoCart = r => require(['@/components/cart/AddtoCart'], r);
const InterestInformation = r => require(['@/components/cart/InterestInformation'], r);
const InterestDetail = r => require(['@/components/cart/InterestDetail'], r);
...
const bindShop = r => require(['@/components/person/bindShop'], r);
const userTuan = r => require(['@/components/person/userTuan'], r);
const userChoice = r => require(['@/components/person/userChoice'], r);
const myaddTuan = r => require(['@/components/person/myaddTuan'], r);
const userGroup = r => require(['@/components/person/userGroup'], r);
...
const generalClass = r => require(['@/components/home/class'], r);
const subCategories = r => require(['@/components/home/children/subCategories'], r);
const Map = r => require(['@/components/home/baiduMap'], r);
...
const comment =r => require(['@/components/product/comment'], r); //商品详情
const coupon = r => require(['@/components/product/coupon'], r); //优惠券
const allCoupons = r => require(['@/components/shopCon/allCoupons'], r);
...
//分销中心
const distribution = r => require(['@/components/distribution/index'],r);
const bestFruit = r => require(['@/components/distribution/bestFruit'],r);//分销中心
        ...
        children: [
            ...
            },
            {
                ...
                children: [ //地址为/subject跳转home
                    ...
                    {
                        path: '/interestInformation/:id',
                        name: 'InterestInformation',
                        component: InterestInformation
                    },
                    {
            ...
            {
                path: '/goodsClassification/:class_id',
